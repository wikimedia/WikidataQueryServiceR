...
#' @param example_name The name of the example as it appears on \href{https://www.wikidata.org/wiki/Wikidata:SPARQL_query_service/queries/examples}{this page}
#' @param ... Additional \code{httr} configurations passed to \code{rvest}
#' @return The SPARQL query as a character vector.
#' @examples
#' \dontrun{
#' sparql_query <- scrape_example("Cats")
#' cat(sparql_query)
